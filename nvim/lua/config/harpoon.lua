...
vim.keymap.set("n", "<leader>p8", function() ui.nav_file(8) end)
vim.keymap.set("n", "<leader>p9", function() ui.nav_file(7) end)
vim.keymap.set("n", "<leader>p0", function() ui.nav_file(8) end)
